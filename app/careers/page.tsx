...
const FALLBACK_POSITIONS = [
  {
    ...
    positions: [
      ...
      },
      {
        ...
        location: "시청",
        type: "정규직",
        description: "정성을 빚어 맛을 완성하는, 진진만두와 함께할 당신을 기다립니다.",
      },
      {
        title: "홀 스태프",
        brand: "분지로",
        location: "명동 / 잠실 롯데월드몰 / 잠실 롯데백화점",
        type: "정규직",
        description: "한 점의 돈카츠에도 기준을 담는 곳, 분지로에서 당신을 찾습니다.",
      },
      {
        ...
        location: "한남",
        type: "정규직",
        description: "한 점의 스시, 한 점의 사시미로 완성되는 공간. 다이센 스시에서 함께할 당신을 찾습니다.",
      },
      {
        title: "홀 스태프",
        brand: "타쿠미나가사키",
        location: "고속터미널",
        type: "정규직",
        description: "장인의 기술을 일상으로, 타쿠미 나가사키에서 함께합니다.",
      },
      {
        title: "홀 스태프",
        brand: "진가와",
        location: "잠실 / 서면",
        type: "정규직",
        description: "360년 장인의 기술을 잇는 곳, 진가와에서 함께하세요.",
      },
    ],
  },
  {
