...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const jaStaticPages: MetadataRoute.Sitemap = [
    { url: `${baseUrl}/jp`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/jp/about`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/jp/brands`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
  ];

  const jaBrandPages: MetadataRoute.Sitemap = brands.map((brand) => ({
    url: `${baseUrl}/jp/brands/${brand.id}`,
    lastModified: now,
    changeFrequency: "weekly" as const,
    priority: 0.7,
  }));
