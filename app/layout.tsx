...
export const metadata: Metadata = {
  ...
  description:
    "넥스트다이닝은 봉우리 한정식, 진가와, 분지로, 다이센스시 등 10개 프리미엄 외식 브랜드를 운영하는 멀티 브랜드 그룹입니다. 서울·수원·부산·여주·뉴욕 24개 직영 매장에서 정통 일식·한식의 진수를 선보입니다.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "10개 프리미엄 외식 브랜드, 서울·수원·부산·여주·뉴욕 24개 직영 매장",
