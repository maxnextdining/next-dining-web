...
export interface Brand {
  ...
  keywordsJa?: string[]; // 일본어 SEO 키워드 (/ja 전용)
  priceRange?: string;
  cuisine?: string;
  website?: string;
  ...
  chefNameJa?: string;  // 장인/셰프 이름 (일본어, /ja 전용)
  chefTitleJa?: string; // 장인/셰프 직함/소개 (일본어, /ja 전용)
  cuisineJa?: string;   // 요리 카테고리 라벨 (일본어, /ja 전용)
...
export const brands: Brand[] = [
  {
    ...
    chefName: '이하연 명인',
    chefNameJa: 'イ・ハヨン名人',
    chefTitleJa: '大韓民国国家認定キムチ名人 第58号',
    ...
    keywordsJa: ['韓定食', 'プレミアム韓食', '驛三ビジネスランチ', '乙支路の韓定食', 'ソウル韓定食おすすめ', '接待レストラン'],
    priceRange: '₩₩₩₩',
    accentColor: '#8B6914',
  ...
  },
  {
    ...
    keywordsJa: ['驪州グルメ', '驪州新世界レストラン', 'アウトレット韓食', '京畿道の韓定食'],
    priceRange: '₩₩₩',
    accentColor: '#8B6914',
  ...
  },
  {
    ...
    keywordsJa: ['市庁マンドゥ', '市庁ランチグルメ', '手作り餃子ソウル', '市庁駅グルメ', '餃子専門店', '黄海道式餃子'],
    priceRange: '₩₩',
    accentColor: '#B91C1C',
    gallery: [
      '/images/brands/gallery/jinjin-mandu/store-1.jpg',
      '/images/brands/gallery/jinjin-mandu/store-2.jpg',
      '/images/brands/gallery/jinjin-mandu/store-3.jpg',
      '/images/brands/gallery/jinjin-mandu/store-4.jpg',
      '/images/brands/gallery/jinjin-mandu/store-5.jpg',
      '/images/brands/gallery/jinjin-mandu/store-6.jpg',
      '/images/brands/gallery/jinjin-mandu/store-7.jpg',
      '/images/brands/gallery/jinjin-mandu/store-8.jpg',
      '/images/brands/gallery/jinjin-mandu/store-9.jpg',
      '/images/brands/gallery/jinjin-mandu/store-10.jpg',
      '/images/brands/gallery/jinjin-mandu/store-11.jpg',
      '/images/brands/gallery/jinjin-mandu/store-12.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-1.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-2.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-3.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-4.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-5.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-6.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-7.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-8.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-9.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-10.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-11.jpg',
      '/images/brands/gallery/jinjin-mandu/menu-12.jpg',
    ],
    cuisine: '한식',
    cuisineJa: '韓食',
    menuHighlights: [
  ...
  },
  {
    ...
    keywordsJa: ['JINKAWA', '驛三そば', '汝矣島和食', '乙支路そば', '光化門グルメ', '蚕室和食', '本格そば', 'ロッテワールドモールグルメ', '江南和食堂', '釜山そば'],
    priceRange: '₩₩₩',
    accentColor: '#1E3A5F',
    gallery: [
  ...
  },
  {
    ...
    keywordsJa: ['BUNJIRO', '長崎とんかつ', '明洞とんかつ', '漢南グルメ', 'サウンズ漢南レストラン', 'ロッテワールドモールとんかつ', '漢南デートコース', 'ソウルとんかつ', '日本職人とんかつ'],
    priceRange: '₩₩₩',
    accentColor: '#4A2C2A',
  ...
  },
  {
    ...
    keywordsJa: ['大山スシ', '漢南プライベートスシ', '漢南洞スシ', 'ソウルプレミアムスシ', '漢南デートコース', '特別な日レストランソウル', 'サウンズ漢南スシ', '韓国高級寿司'],
    priceRange: '₩₩₩₩',
    accentColor: '#8B7355',
  ...
  },
  {
    ...
    keywordsJa: ['タクミナガサキ', '高速ターミナル和食', '龍山和食堂', 'アイパークモールグルメ', 'ファインカジュアル和食', '長崎料理'],
    priceRange: '₩₩₩',
    accentColor: '#2C3E50',
  ...
  },
  {
    ...
    keywordsJa: ['MENYA ALWAYS', 'ソウルラーメン', '本格日本ラーメン', 'ラーメングルメソウル', '聖水ラーメン', '豚骨ラーメン'],
    priceRange: '₩₩',
    accentColor: '#C41E3A',
    cuisine: '라멘',
    cuisineJa: 'ラーメン',
  ...
  },
  {
    ...
    keywordsJa: ['カフェルサンス', '漢南洞カフェ', 'サウンズ漢南カフェ', '漢南ブランチ', '漢南デートカフェ', '龍山カフェおすすめ'],
    priceRange: '₩₩',
    accentColor: '#6B4C3B',
  ...
  },
  {
    ...
    keywordsJa: ['NOFLEX NYC', 'ニューヨーク韓国レストラン', 'メディアアートレストランNYC', '没入型ダイニングNYC', 'マンハッタンカクテルバー', 'Kダイニング', 'ネクストダイニングNY'],
    priceRange: '$$$',
    accentColor: '#5B21B6',
