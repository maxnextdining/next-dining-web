...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    category: 'japanese',
    format: 'dining',
    tagline: '360년, 12대를 이어온 일본 장인의 면 다이닝',
    description:
      '진가와는 일본 나가사키 시마바라에서 시작된 전통 제면 기술을 바탕으로, 면 요리와 프리미엄 일식을 함께 즐길 수 있는 다이닝 브랜드입니다.',
    story:
      '진가와는 일본 나가사키 시마바라에서 시작된 전통 제면 기술을 바탕으로, 면 요리와 프리미엄 일식을 함께 즐길 수 있는 다이닝 브랜드입니다.',
    storyElements: {
      originStory: '1644년부터 12대째 가업을 이어온 진가와 제면소의 기술력으로 시작되었습니다. 전통 수연면 제조 방식과 일본 미식 문화를 현대적인 다이닝으로 확장했습니다.',
      chefOrArtisan: '360년 장인 기술 — 3일간 18단계를 거쳐 완성하는 전통 테노베면',
      ingredientPhilosophy: '전통 방식으로 완성한 면 — 3일간 18단계를 거쳐 만드는 테노베면으로 깊이 있는 식감을 완성합니다. 엄선한 제철 해산물 — 사시미와 일식 메뉴에는 신선한 재료만을 사용해 본연의 풍미를 살립니다. 기본에 충실한 맛 — 육수, 간장, 소스까지 일본 정통 방식의 밸런스를 중요하게 생각합니다.',
      signatureMenu: '360년 제면 기술로 완성한 면 요리와 신선한 사시미, 정갈한 정식 구성까지 일본 정통 미식을 한 자리에서 경험할 수 있습니다.',
      spaceExperience: '점심 미팅부터 저녁 모임, 가족 외식까지 격식과 편안함을 함께 갖춘 프리미엄 일식 공간입니다.',
    },
    ...
    cuisine: '소바',
    menuHighlights: [
      { name: '스키야키 나�� 코스', price: '49,000원', photo: '/images/brands/story/jinkawa/menu1.jpg' },
      { name: '가이세키 코스', price: '59,000원', photo: '/images/brands/story/jinkawa/menu2.jpg' },
      { name: '셰프 스페셜 코스', price: '79,000원', photo: '/images/brands/story/jinkawa/menu3.jpg' },
      { name: '사시미 & 스시 정식', price: '37,000원~49,000원', photo: '/images/brands/story/jinkawa/menu4.jpg' },
    ],
    reservationLinks: [
  ...
  },
  {
    ...
    priceRange: '₩₩',
    accentColor: '#6B4C3B',
    gallery: ['/images/brands/gallery/cafe-le-sens/update-1.jpg', '/images/brands/gallery/cafe-le-sens/update-2.jpg', '/images/brands/gallery/cafe-le-sens/update-3.jpg', '/images/brands/gallery/cafe-le-sens/update-4.jpg', '/images/brands/gallery/cafe-le-sens/update-5.jpg', '/images/brands/gallery/cafe-le-sens/update-6.jpg', '/images/brands/gallery/cafe-le-sens/update-7.jpg', '/images/brands/story/cafe-le-sens/summary.jpg', '/images/brands/gallery/cafe-le-sens/new-1.jpg', '/images/brands/gallery/cafe-le-sens/new-2.jpg', '/images/brands/gallery/cafe-le-sens/new-3.jpg', '/images/brands/gallery/cafe-le-sens/new-4.jpg', '/images/brands/gallery/cafe-le-sens/new-5.jpg', '/images/brands/gallery/cafe-le-sens/new-6.jpg', '/images/brands/gallery/cafe-le-sens/new-7.jpg', '/images/brands/gallery/cafe-le-sens/new-8.jpg', '/images/brands/gallery/cafe-le-sens/new-9.jpg', '/images/brands/gallery/cafe-le-sens/new-10.jpg', '/images/brands/gallery/cafe-le-sens/store-1.jpg', '/images/brands/gallery/cafe-le-sens/store-2.jpg', '/images/brands/gallery/cafe-le-sens/store-3.jpg', '/images/brands/gallery/cafe-le-sens/menu-1.jpg', '/images/brands/gallery/cafe-le-sens/menu-2.jpg', '/images/brands/gallery/cafe-le-sens/menu-3.jpg', '/images/brands/gallery/cafe-le-sens/menu-4.jpg'],
    cuisine: '카페',
    menuHighlights: [
