...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    story:
      '진가와는 일본 나가사키 시마바라에서 시작된 전통 제면 기술을 바탕으로, 면 요리와 프리미엄 일식을 함께 즐길 수 있는 다이닝 브랜드입니다.',
    storyElements: {
      originStory: '360년 동안 진가와 가문은 나가사키현 시나미 시마바라시에서 12대를 이어 일본 전통 테노베면(수연면)을 생산하고 있습니다. 3일간 18단계를 거쳐 반죽을 꼬고 늘리는 숙성 과정을 수차례 반복해 만드는 전통 방식으로 촉감이 부드럽고 목넘김이 부드러운 특유의 식감을 가진 면이 탄생됩니다.',
