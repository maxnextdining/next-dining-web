...
export const brands: Brand[] = [
  {
    ...
    storyElements: {
      ...
      chefOrArtisan: '이하연 명인 — 대한민국 식품명인 제67호. 40년 넘게 김치와 장류 연구에 매진하며 한국 발효 식문화의 깊이를 세계에 알리고 있습니다.',
  ...
  },
  {
    ...
    storyElements: {
      originStory: '큐슈 지방 압도적 1위 스시 브랜드 와카타케마루(若竹丸)의 한국 상륙. 일본 현지에서 검증된 오마카세 기술과 철학을 한남동에 그대로 이식했습니다.',
      chefOrArtisan: '와카타케마루 출신 스시 장인 — 큐슈산 제철 생선의 특성을 꿰뚫고, 숙성·온도·손놀림까지 와카타케마루의 정통 기술을 계승한 셰프가 카운터를 책임집니다.',
      ingredientPhilosophy: '큐슈산 제철 생선을 직접 공수. 숙성 기술로 감칠맛을 극대화하며, 샤리(초밥밥)의 온도와 식초 배합까지 세밀하게 관리합니다.',
      signatureMenu: '오마카세 코스 — 셰프가 그날의 최고 식재료로 구성하는 프리미엄 스시 코스. 7석 카운터에서 셰프의 손놀림을 바로 앞에서 감상하며 즐깁니다.',
  ...
  },
  {
    ...
    storyElements: {
      originStory: '진한 한 그릇의 위안. 일본 라멘의 정통성을 지키면서도 한국인의 입맛에 맞는 깊은 맛을 연구해 탄생한 라멘 브랜드.',
      ingredientPhilosophy: '매일 12시간 이상 우려낸 진국 육수. 면은 라멘 전용 제면기로 매일 뽑아 최적의 식감을 유지합니다.',
      signatureMenu: '진국 돈코츠 라멘 — 12시간 우린 돼지뼈 육수와 쫄깃한 자가제면의 조화. 차슈, 아지타마고까지 정통 스타일 그대로.',
    },
    locations: [],
