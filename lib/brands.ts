...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    description:
      '다이센 스시는 규슈 지역을 대표하는 스시 전문 브랜드로, 신선한 회와 특제 샤리초, 간장이 어우러진 정통 장인의 초밥을 제공합니다. 압도적인 품질과 합리적인 가격 경쟁력을 바탕으로, 나만을 위한 프라이빗하고 고품격인 식문화를 경험하고자 하는 고객들에게 최고의 선택지를 제안합니다.',
    story:
      '다이센 스시는 규슈 지역을 대표하는 스시 전문 브랜드로, 신선한 회와 특제 샤리초, 간장이 어우러진 정통 장인의 초밥을 제공합니다. 압도적인 품질과 합리적인 가격 경쟁력을 바탕으로, 나만을 위한 프라이빗하고 고품격인 식문화를 경험하고자 하는 고객들에게 최고의 선택지를 제안합니다.',
    storyElements: {
