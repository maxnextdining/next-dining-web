...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    storyElements: {
      ...
      ingredientPhilosophy: '국내산 최고급 돼지고기, 자연산 블랙 타이거 새우, 국내산 닭다리살 등 프리미엄 식재료만을 사용하여 요리합니다. 수십 년간 쌓아온 장인의 노하우를 바탕으로 고기의 숙성부터 튀김 온도까지 엄격하게 관리해 요리하고 있습니다.',
      ...
      spaceExperience: '\'카메야마\'는 \'타카다 유지\' 장인의 가문에서 대대로 전통을 이어 운영하고 있는 도자기 브랜드입니다. \'사카모토 료마\'(메이지 유신을 이끈 인물)가 최초 해외 무역을 했던 명품 도자기로 서양 세계에 일본 도자기를 알리는데 큰 공헌을 한 역사적인 브랜드입니다. 분지로의 돈카츠 그릇, 도자기 맥주잔 등 역사를 담은 그릇을 분지로 전 매장에서 만나볼 수 있습니다.',
    },
